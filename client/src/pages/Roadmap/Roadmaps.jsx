...
export default function Roadmaps() {
    ...
    return(
        <div>
            ...
            <ul className="flex flex-row flex-wrap gap-4 items-center py-4 px-1 sm:py-8">
                    {roadmaps.map((roadmap) => (
                        <Link key={roadmap.name} to={roadmap.id} className="bg-[#EEEEEE99] w-fit rounded-md cursor-pointer">
